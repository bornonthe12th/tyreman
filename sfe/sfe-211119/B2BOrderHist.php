	...
	if ($num>0) {
		...
		while ($i < $num) {
			...
			if (mysql_result($srchresult,$i,"order_id")==$order_id) {
				...
				echo "<tr><th width=120 class=titlemedium>Order&nbsp;ID</th>";
				echo "<th width=120 class=titlemedium>Order&nbsp;Date</th>";
				echo "<th width=150 class=titlemedium>Order&nbsp;Ref</th>";
				echo "<th class=titlemedium>Stock&nbsp;Code</th>";
				echo "<th width=100 class=titlemedium>Quantity</th>";
				echo "<th width=120 class=titlemedium>Price</th>";	
				echo "<tr><td class=$tdclass align=center > " .str_pad(mysql_result($srchresult,$i,"order_id"), 8, "0", STR_PAD_LEFT). "</td>";
  				echo "<td class=$tdclass align=center nowrap=true>&nbsp;" . mysql_result($srchresult,$i,"order_date"). "&nbsp;</td>";
