...
include 'Reconnect.php';	
	...
	if ($num>0) {
		...
		echo "</th></tr>";
		echo "<tr><td>&nbsp;&nbsp;Mark Up percent&nbsp;</td><td>&nbsp&nbsp&nbsp<input type=text value='" .
		     mysql_result($srchresult,0,"markuppc" ) ."' name=markuppc> </input>&nbsp&nbsp</td></tr>"; 
		echo "<tr><td>&nbsp;&nbsp;Mark Up Value&nbsp;</td><td>&nbsp&nbsp&nbsp<input type=text value='" .
		     mysql_result($srchresult,0,"markupval") ."' name=markupval></input>&nbsp&nbsp</td></tr>";	
