...
<?php
	...
	echo '<tr><td CLASS=maintitle>Your Comments / Instructions</td></tr>';
	echo '<tr><td><input type=text maxlength=32 size=32 name=comments1 /></td></tr>';
	echo '<tr><td><input type=text maxlength=32 size=32 name=comments2 /></td></tr>';
	echo '<tr><td><input type=text maxlength=32 size=32 name=comments3 /></td></tr>';
	echo '<tr><td><input type=text maxlength=32 size=32 name=comments4 /></td></tr>';
	echo '<tr><td></td></tr>';
        echo '<tr><td></td></tr>';
        echo '<tr><td></td></tr>';

	echo '<tr><td CLASS=maintitle>Your Reference &nbsp;<input type=text name=ordref size="10" maxlength="10" /></td></tr>';
	echo '<tr><td><input type=submit name=process value="Complete Order" /> ';
