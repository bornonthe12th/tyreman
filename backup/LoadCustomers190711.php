...
if($debug) echo $query . "<br />";
				...
				$query="insert into customers (title,first_name,surname,phone,mobile,fax,account_no,delivery_add_id,default_branch_id,credit_limit,trade_limit,account_balance,on_stop_flag,enquiry_only) values ";	
			    $query = $query."('" .$data[5] . "',";
			    $query = $query."'". $data[6] . "',";
			    $query = $query."'". $data[7] . "',";
			    $query = $query."'". $data[8] . "',";
